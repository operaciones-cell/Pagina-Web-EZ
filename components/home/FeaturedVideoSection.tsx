    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <motion.div
          ...
          className="ambient-shadow relative aspect-video overflow-hidden rounded-3xl"
        >
          <video
            src={FEATURED_VIDEO}
            muted
          ...
          />
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#00101f]/60 via-transparent to-transparent" />
          ...
          <div className="absolute bottom-0 left-0 right-0 flex flex-col items-start justify-between gap-4 p-6 md:flex-row md:items-end md:p-10">
            <div className="max-w-md rounded-2xl p-6 md:p-8" style={{ backgroundColor: "rgba(251, 249, 244, 0.95)", backdropFilter: "blur(20px)" }}>
              <p className="mb-3 text-xs uppercase tracking-[0.28em]" style={{ color: "#c7a84b" }}>
                Crème Brûlée · Receta firma
              </p>
              <p className="text-sm leading-relaxed md:text-base" style={{ color: "#00101f" }}>
