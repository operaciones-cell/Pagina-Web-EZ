...
export default function AboutSection() {
  ...
  return (
    <section
      ref={ref}
      className="section-divider relative overflow-hidden px-6 pt-28 pb-16 md:pt-40 md:pb-20"
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at top, rgba(199,168,75,0.06) 0%, transparent 70%)",
        }}
      />
