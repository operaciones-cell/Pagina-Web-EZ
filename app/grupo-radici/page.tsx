...
const ROOTS = [
  { name: "Eliana Zaia", detailKey: "Eliana Zaia",              tag: "REPOSTERÍA", delay: 0   },
  { name: "El Tinto",    detailKey: "El Tinto",                 tag: "CAFETERÍA",  delay: 0.1 },
  { name: "EZ Treats",   detailKey: "EZ Treats",                tag: "PRODUCCIÓN", delay: 0.2 },
  { name: "Moldeza",     detailKey: "Moldeza",                  tag: "INSUMOS",    delay: 0.3 },
  { name: "Radici WM",   detailKey: "Radici Wealth Management", tag: "FINANZAS",   delay: 0.4 },
];
    ...
    <div className="relative hidden w-full max-w-3xl flex-col items-center md:flex">
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <motion.div
          ...
          transition={{ duration: 2.4, ease: [0.15, 0.55, 0.35, 1] }}
        />
      </div>
      ...
      <div className="mt-5 grid w-full grid-cols-5">
        {ROOTS.map((root, i) => (
          ...
          >
            ...
            <span
              className="mt-1 text-[12px] tracking-[0.18em]"
